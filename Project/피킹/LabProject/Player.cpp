...
CPlayer::CPlayer()
{
	...
	m_xmf3Position = XMFLOAT3(0.0f, 0.0f, -490.0f);
...
{
	m_vecBullet.emplace_back(new CBullet(GetPosition(),GetRight(), GetUp(), GetLook(), m_xmf3Velocity, GetMovingDirection()));
}

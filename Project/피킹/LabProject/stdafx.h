...
namespace Vector4
{
	...
	//inline XMFLOAT4 Multiply(XMFLOAT4& xmf4Vector1, XMFLOAT4X4& xmmtx4x4Matrix1)
	//{
	//	XMFLOAT4 xmmtx4x4Result;dbwj
	//	XMStoreFloat4x4(&xmmtx4x4Result, XMLoadFloat4(&xmf4Vector1) * XMLoadFloat4x4(&xmmtx4x4Matrix1));
	//	return(xmmtx4x4Result);
	//}
	//inline XMFLOAT4 Multiply(XMFLOAT4& xmf4Vector1, XMFLOAT4X4& xmmtx4x4Matrix1)
	/*{
		XMFLOAT4 xmmtx4x4Result;
		XMStoreFloat4x4(&xmmtx4x4Result, XMLoadFloat4x4(&xmmtx4x4Matrix1) * XMLoadFloat4(&xmf4Vector1));
		return(xmmtx4x4Result);
	}*/
}

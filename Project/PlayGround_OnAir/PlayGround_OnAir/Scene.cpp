...
//
	...
	pShadowShader->m_pScene = this;
	pShadowShader->CreateShader(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature);
	pShadowShader->BuildObjects(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, NULL);
	m_ppShaders[6] = pTimeBarUIShader;*/
...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	//pd3dRootParameters[18].Constants.Num32BitValues = 33;
	//pd3dRootParameters[18].Constants.ShaderRegister = 2; //GameObject

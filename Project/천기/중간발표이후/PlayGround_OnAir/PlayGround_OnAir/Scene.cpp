...
//PLAYER->AddPlayer()
   ...
   //°íÄ£¹öÁ¯
	...
	CLoadedModelInfo * Pillar1 = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/¸Ê2/¸Ê2±âµÕ.bin", NULL, false);
	...
	CLoadedModelInfo * Pillar2 = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/¸Ê2/¸Ê2±âµÕ.bin", NULL, false);
	...
	CLoadedModelInfo * Front_Speaker1 = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/¸Ê2/ºí·ç½ºÇÇÄ¿.bin", NULL, false);
	...
	CLoadedModelInfo * Front_Speaker2 = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/¸Ê2/ºí·ç½ºÇÇÄ¿.bin", NULL, false);
	...
	CLoadedModelInfo * C_Stage_Speaker1 = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/¸Ê2/ºí·çÁ÷°¢½ºÇÇÄ¿.bin", NULL, false);
	...
	CLoadedModelInfo * C_Stage_Speaker2 = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/¸Ê2/ºí·çÁ÷°¢½ºÇÇÄ¿.bin", NULL, false);
	...
	CLoadedModelInfo * C_Stage_Speaker3 = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/¸Ê2/ºí·çÁ÷°¢½ºÇÇÄ¿.bin", NULL, false);
	...
	CLoadedModelInfo * C_Stage_Speaker4 = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/¸Ê2/ºí·çÁ÷°¢½ºÇÇÄ¿.bin", NULL, false);

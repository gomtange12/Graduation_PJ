...
public class TextHierarchicalModelExtract : MonoBehaviour
{
    private StreamWriter BinaryWriter = null;
    private int nFrames = 0;

    void WriteTabs(int nLevel)
    {
        for (int i = 0; i < nLevel; i++) BinaryWriter.Write("\t");
    }
    ...
    {
        WriteTabs(nLevel);
        BinaryWriter.WriteLine(strToWrite);
    }
    ...
    void WriteObjectName(int nLevel, string strHeader, Object obj)
    {
        ...
        BinaryWriter.WriteLine((obj) ? string.Copy(obj.name).Replace(" ", "_") : "null");
    }
    ...
    void WriteVectors(int nLevel, string strHeader, Vector2[] vectors)
    {
        ...
        if (vectors.Length > 0)
        {
            foreach (Vector2 v in vectors) BinaryWriter.Write(v.x + " " + v.y + " ");
        }
    ...
    void WriteVectors(int nLevel, string strHeader, Vector3[] vectors)
    {
        ...
        if (vectors.Length > 0)
        {
            foreach (Vector3 v in vectors) BinaryWriter.Write(v.x + " " + v.y + " " + v.z + " ");
        }
        BinaryWriter.WriteLine(" ");
    }
    ...
    void WriteVectors(int nLevel, string strHeader, Vector4[] vectors)
    {
        ...
        if (vectors.Length > 0)
        {
            foreach (Vector4 v in vectors) BinaryWriter.Write(v.x + " " + v.y + " " + v.z + " " + v.w + " ");
        }
        BinaryWriter.WriteLine(" ");
    }
    ...
    void WriteColors(int nLevel, string strHeader, Color[] colors)
    {
        ...
        if (colors.Length > 0)
        {
            foreach (Color c in colors) BinaryWriter.Write(c.r + " " + c.g + " " + c.b + " " + c.a + " ");
        }
        BinaryWriter.WriteLine(" ");
    }
    ...
    void WriteTextureCoords(int nLevel, string strHeader, Vector2[] uvs)
    {
        ...
        if (uvs.Length > 0)
        {
            foreach (Vector2 uv in uvs) BinaryWriter.Write(uv.x + " " + (1.0f - uv.y) + " ");
        }
        BinaryWriter.WriteLine(" ");
    }
    ...
    void WriteIntegers(int nLevel, string strHeader, int[] integers)
    {
        ...
        if (integers.Length > 0)
        {
            foreach (int i in integers) BinaryWriter.Write(i + " ");
        }
        BinaryWriter.WriteLine(" ");
    }
    ...
    void WriteMatrix(Matrix4x4 matrix)
    {
        BinaryWriter.Write(matrix.m00 + " " + matrix.m10 + " " + matrix.m20 + " " + matrix.m30 + " ");
        BinaryWriter.Write(matrix.m01 + " " + matrix.m11 + " " + matrix.m21 + " " + matrix.m31 + " ");
        BinaryWriter.Write(matrix.m02 + " " + matrix.m12 + " " + matrix.m22 + " " + matrix.m32 + " ");
        BinaryWriter.Write(matrix.m03 + " " + matrix.m13 + " " + matrix.m23 + " " + matrix.m33 + " ");
    }
    ...
    void WriteFrameInfo(int nLevel, Transform current)
    {
        ...
        WriteString(nLevel + 1, "<Transform>: ");
        BinaryWriter.Write(current.localPosition.x + " " + current.localPosition.y + " " + current.localPosition.z + " ");
        BinaryWriter.Write(current.localEulerAngles.x + " " + current.localEulerAngles.y + " " + current.localEulerAngles.z + " ");
        BinaryWriter.Write(current.localScale.x + " " + current.localScale.y + " " + current.localScale.z + " ");
        BinaryWriter.Write(current.localRotation.x + " " + current.localRotation.y + " " + current.localRotation.z + " " + current.localRotation.w + " ");
        BinaryWriter.WriteLine(" ");
    ...
    void Start()
    {
        BinaryWriter = new StreamWriter(string.Copy(gameObject.name).Replace(" ", "_") + ".txt");

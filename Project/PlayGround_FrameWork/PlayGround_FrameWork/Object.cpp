...
void CTexture::SetRootArgument(int nIndex, UINT nRootParameterIndex, D3D12_GPU_DESCRIPTOR_HANDLE d3dSrvGpuDescriptorHandle)
{
	...
	//리소스접근하는 포인터 얘에 ㅈ버근해서 데이터 읽음. 
	//각 쉐이더 내의 md3d 리소스 그거 만든거. 이거를 이 파라미터에서 인자로 넘기는데 각텍스쳐의 정의된 정보. 
}
...
void CRotatingObject::Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera, UINT nObjects)
{
	CGameObject::Render(pd3dCommandList, pCamera, nObjects);
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
CHeightMapTerrain::CHeightMapTerrain(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, LPCTSTR pFileName, int nWidth, int nLength, int nBlockWidth, int nBlockLength, XMFLOAT3 xmf3Scale, XMFLOAT4 xmf4Color, int terrainID) : CGameObject(0)
{
	m_nWidth = nWidth;
	m_nLength = nLength;

	m_nTerrainID = terrainID;
	int cxQuadsPerBlock = nBlockWidth - 1;
	int czQuadsPerBlock = nBlockLength - 1;

	m_xmf3Scale = xmf3Scale;

	m_pHeightMapImage = new CHeightMapImage(pFileName, nWidth, nLength, xmf3Scale, m_nTerrainID);
	...
	for (int z = 0, zStart = 0; z < czBlocks; z++)
	{
		for (int x = 0, xStart = 0; x < cxBlocks; x++)
		{
			...
			pHeightMapGridMesh = new CHeightMapGridMesh(pd3dDevice, pd3dCommandList, xStart, zStart, nBlockWidth, nBlockLength, terrainID, xmf3Scale, xmf4Color, m_pHeightMapImage);
	...
	pTerrainTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, L"Image/Sand01S.dds", 2);
	...
	//pTerrainShader->CreateShaderResourceViews(pd3dDevice, pd3dCommandList, pTerrainTexture[1], 5, false);
	//pTerrainShader->CreateShaderResourceViews(pd3dDevice, pd3dCommandList, pTerrainTexture[2], 8, false);
...
{
	XMStoreFloat4x4(&m_pcbMappedGameObject->m_xmf4x4World, XMMatrixTranspose(XMLoadFloat4x4(&m_xmf4x4World)));
	m_pcbMappedGameObject->m_terrainID = m_nTerrainID;
}
...
//{
//	m_ppMeshes[0] = new CTexturedRectMesh(pd3dDevice, pd3dCommandList, 20.f, 20.f, 0.f, 0.f, 0.f, +10.f);
//	m_ppMeshes[1] = new CTexturedRectMesh(pd3dDevice, pd3dCommandList, 20.f, 20.f, 0.f, 0.f, 0.f, -10.f);
//	m_ppMeshes[2] = new CTexturedRectMesh(pd3dDevice, pd3dCommandList, 0.f, 20.f, 20.f, -10.f, 0.f, 0.f);
//	m_ppMeshes[3] = new CTexturedRectMesh(pd3dDevice, pd3dCommandList, 0.f, 20.f, 20.f, 10.f, 0.f, 0.f);
//	m_ppMeshes[4] = new CTexturedRectMesh(pd3dDevice, pd3dCommandList, 20.f, 0.f, 20.f, 0.f, 10.f, 0.f);
//	m_ppMeshes[5] = new CTexturedRectMesh(pd3dDevice, pd3dCommandList, 20.f, 0.f, 20.f, 0.f, -10.f, 0.f);
//
//	//m_nUploadBuffers = 6;
//	//m_pp3dUploadBuffers = new ID3D12Resource*[m_nUploadBuffers];
//
//}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// 
...
void CGrassObject::SetLookAt(XMFLOAT3 & xmf3Target)
{
	XMFLOAT3 xmf3Up = { 0.0f, 1.0f, 0.0f };
	XMFLOAT3 xmf3Position(m_xmf4x4World._41, m_xmf4x4World._42, m_xmf4x4World._43);
	XMFLOAT3 xmf3Look = Vector3::Subtract(xmf3Target, xmf3Position);
...
void CTreeObject::Animate(float fTimeElapsed, CCamera* pCamera)
{
...
void CTreeObject::SetLookAt(XMFLOAT3 & xmf3Target)
{
	XMFLOAT3 xmf3Up = { 0.0f, 1.0f, 0.0f };
	XMFLOAT3 xmf3Position(m_xmf4x4World._41, m_xmf4x4World._42, m_xmf4x4World._43);
	XMFLOAT3 xmf3Look = Vector3::Subtract(xmf3Target, xmf3Position);
